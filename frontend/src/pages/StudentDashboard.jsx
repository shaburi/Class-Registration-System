...
export default function StudentDashboard() {
    ...
    const handleConfirmSwap = async (targetStudentId, sectionId) => {
        await requestSwap(targetStudentId, sectionId);
    ...
    const handleBulkRegister = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                toast.success(`Registered ${selectedBuilderSections.length} courses!`);
    ...
    return (
        ...
        >
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6 dark:bg-gray-800 transition-colors min-h-[500px]">
                            ...
                            <>
                                <div className="mb-6">
                                    ...
                                    <select
                                        ...
                                        className="w-full max-w-md p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white"
                                    >
                                ...
                                <div className="mb-6">
                                    <div className="relative max-w-md">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white"
                                        />
                                    </div>
                                </div>

                                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                                    <div className="lg:col-span-1 max-h-[500px] overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-xl p-2 space-y-2">
